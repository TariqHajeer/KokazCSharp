USE [master]
GO
/****** Object:  Database [Kokaz]    Script Date: 3/22/2021 5:27:21 AM ******/
...
USE [Kokaz]
GO
/****** Object:  Table [dbo].[clientPhones]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Clients]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Country]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Currency]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Group]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[GroupPrivilege]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Income]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IncomeType]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MoenyPlaced]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Order]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Order](
	...
	[AgentPrintNumber] [int] NULL,
	[ClientPrintNumber] [int] NULL,
...
GO
/****** Object:  Table [dbo].[OrderItem]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderPlaced]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderState]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderType]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OutCome]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OutComeType]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Printed]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Privilege]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Region]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserGroup]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserPhone]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 3/22/2021 5:27:21 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Order] ([Id], [Code], [ClientId], [CountryId], [DeliveryCost], [Cost], [OldCost], [AgentCost], [RecipientName], [RecipientPhones], [RegionId], [Address], [ClientNote], [CreatedBy], [MoenyPlacedId], [OrderplacedId], [Date], [DiliveryDate], [Note], [AgentId], [seen], [IsClientDiliverdMoney], [IsSync], [OrderStateId], [AgentPrintNumber], [ClientPrintNumber]) VALUES (3041, N'1', 1011, 1012, CAST(7000.00 AS Decimal(18, 2)), CAST(90000.00 AS Decimal(18, 2)), NULL, CAST(4000.00 AS Decimal(18, 2)), NULL, N'321', NULL, NULL, NULL, NULL, 1, 3, CAST(N'2021-03-21' AS Date), NULL, NULL, 10, 1, 1, 0, 1, 5, 6)
INSERT [dbo].[Order] ([Id], [Code], [ClientId], [CountryId], [DeliveryCost], [Cost], [OldCost], [AgentCost], [RecipientName], [RecipientPhones], [RegionId], [Address], [ClientNote], [CreatedBy], [MoenyPlacedId], [OrderplacedId], [Date], [DiliveryDate], [Note], [AgentId], [seen], [IsClientDiliverdMoney], [IsSync], [OrderStateId], [AgentPrintNumber], [ClientPrintNumber]) VALUES (3042, N'2', 1011, 1012, CAST(7000.00 AS Decimal(18, 2)), CAST(50000.00 AS Decimal(18, 2)), NULL, CAST(4000.00 AS Decimal(18, 2)), NULL, N'321', NULL, NULL, NULL, NULL, 1, 3, CAST(N'2021-03-21' AS Date), NULL, NULL, 10, 1, 1, 0, 1, 5, 6)
INSERT [dbo].[Order] ([Id], [Code], [ClientId], [CountryId], [DeliveryCost], [Cost], [OldCost], [AgentCost], [RecipientName], [RecipientPhones], [RegionId], [Address], [ClientNote], [CreatedBy], [MoenyPlacedId], [OrderplacedId], [Date], [DiliveryDate], [Note], [AgentId], [seen], [IsClientDiliverdMoney], [IsSync], [OrderStateId], [AgentPrintNumber], [ClientPrintNumber]) VALUES (3043, N'3', 1011, 1012, CAST(7000.00 AS Decimal(18, 2)), CAST(65464.00 AS Decimal(18, 2)), NULL, CAST(4000.00 AS Decimal(18, 2)), NULL, N'321', NULL, NULL, NULL, NULL, 1, 3, CAST(N'2021-03-21' AS Date), NULL, NULL, 10, 1, 1, 0, 1, 5, 6)
INSERT [dbo].[Order] ([Id], [Code], [ClientId], [CountryId], [DeliveryCost], [Cost], [OldCost], [AgentCost], [RecipientName], [RecipientPhones], [RegionId], [Address], [ClientNote], [CreatedBy], [MoenyPlacedId], [OrderplacedId], [Date], [DiliveryDate], [Note], [AgentId], [seen], [IsClientDiliverdMoney], [IsSync], [OrderStateId], [AgentPrintNumber], [ClientPrintNumber]) VALUES (3044, N'4', 1011, 1012, CAST(7000.00 AS Decimal(18, 2)), CAST(70000.00 AS Decimal(18, 2)), NULL, CAST(4000.00 AS Decimal(18, 2)), NULL, N'111', NULL, NULL, NULL, NULL, 1, 3, CAST(N'2021-03-21' AS Date), NULL, NULL, 10, 1, 1, 0, 1, 5, 6)
INSERT [dbo].[Order] ([Id], [Code], [ClientId], [CountryId], [DeliveryCost], [Cost], [OldCost], [AgentCost], [RecipientName], [RecipientPhones], [RegionId], [Address], [ClientNote], [CreatedBy], [MoenyPlacedId], [OrderplacedId], [Date], [DiliveryDate], [Note], [AgentId], [seen], [IsClientDiliverdMoney], [IsSync], [OrderStateId], [AgentPrintNumber], [ClientPrintNumber]) VALUES (4033, N'5', 1011, 1012, CAST(7000.00 AS Decimal(18, 2)), CAST(156151.00 AS Decimal(18, 2)), NULL, CAST(4000.00 AS Decimal(18, 2)), NULL, N'32132156897', NULL, NULL, NULL, NULL, 1, 3, CAST(N'2021-03-21' AS Date), NULL, NULL, 10, 1, 0, 0, 1, 1002, NULL)
INSERT [dbo].[Order] ([Id], [Code], [ClientId], [CountryId], [DeliveryCost], [Cost], [OldCost], [AgentCost], [RecipientName], [RecipientPhones], [RegionId], [Address], [ClientNote], [CreatedBy], [MoenyPlacedId], [OrderplacedId], [Date], [DiliveryDate], [Note], [AgentId], [seen], [IsClientDiliverdMoney], [IsSync], [OrderStateId], [AgentPrintNumber], [ClientPrintNumber]) VALUES (4034, N'6', 1011, 1012, CAST(7000.00 AS Decimal(18, 2)), CAST(46544654.00 AS Decimal(18, 2)), NULL, CAST(4000.00 AS Decimal(18, 2)), NULL, N'21132132132', NULL, NULL, NULL, NULL, 1, 3, CAST(N'2021-03-21' AS Date), NULL, NULL, 10, 1, 0, 0, 1, 1002, NULL)
INSERT [dbo].[Order] ([Id], [Code], [ClientId], [CountryId], [DeliveryCost], [Cost], [OldCost], [AgentCost], [RecipientName], [RecipientPhones], [RegionId], [Address], [ClientNote], [CreatedBy], [MoenyPlacedId], [OrderplacedId], [Date], [DiliveryDate], [Note], [AgentId], [seen], [IsClientDiliverdMoney], [IsSync], [OrderStateId], [AgentPrintNumber], [ClientPrintNumber]) VALUES (4035, N'7', 1011, 1012, CAST(7000.00 AS Decimal(18, 2)), CAST(50000.00 AS Decimal(18, 2)), NULL, CAST(4000.00 AS Decimal(18, 2)), NULL, N'12321316972', NULL, NULL, NULL, NULL, 1, 3, CAST(N'2021-03-21' AS Date), NULL, NULL, 10, 1, 0, 0, 1, 1002, NULL)
INSERT [dbo].[Order] ([Id], [Code], [ClientId], [CountryId], [DeliveryCost], [Cost], [OldCost], [AgentCost], [RecipientName], [RecipientPhones], [RegionId], [Address], [ClientNote], [CreatedBy], [MoenyPlacedId], [OrderplacedId], [Date], [DiliveryDate], [Note], [AgentId], [seen], [IsClientDiliverdMoney], [IsSync], [OrderStateId], [AgentPrintNumber], [ClientPrintNumber]) VALUES (4036, N'8', 1011, 1012, CAST(7000.00 AS Decimal(18, 2)), CAST(400000.00 AS Decimal(18, 2)), NULL, CAST(4000.00 AS Decimal(18, 2)), NULL, N'12345678910', NULL, NULL, NULL, NULL, 1, 3, CAST(N'2021-03-21' AS Date), NULL, NULL, 10, 1, 0, 0, 1, 1002, NULL)
...
GO
ALTER TABLE [dbo].[Order]  WITH CHECK ADD  CONSTRAINT [FK_Order_Printed] FOREIGN KEY([AgentPrintNumber])
REFERENCES [dbo].[Printed] ([Id])
GO
ALTER TABLE [dbo].[Order] CHECK CONSTRAINT [FK_Order_Printed]
GO
ALTER TABLE [dbo].[Order]  WITH CHECK ADD  CONSTRAINT [FK_Order_Printed1] FOREIGN KEY([ClientPrintNumber])
REFERENCES [dbo].[Printed] ([Id])
GO
ALTER TABLE [dbo].[Order] CHECK CONSTRAINT [FK_Order_Printed1]
GO
